...
boxMaterial.map = loader.load('texture_esd_trained/test_'+noiseInput.value+'.png');
...
boxMaterial_untrained.map = loader.load('texture_esd_trained_reconstruction/test_'+noiseInput.value+'.png');
...
for(var i=0;i<360;i++)
{
  arr.push(loader.load('texture_esd_trained/test_'+i+'.png'));
}
...
for(var i=0;i<360;i++)
{
  arr_untrained.push(loader.load('texture_esd_trained_reconstruction/test_'+i+'.png'));
}
